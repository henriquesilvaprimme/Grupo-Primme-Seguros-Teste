...
const LeadsFechados = ({ leads, usuarios, onUpdateInsurer, onConfirmInsurer, onUpdateDetalhes, fetchLeadsFechadosFromSheet, isAdmin }) => {
  ...
  const currentLeads = fechadosFiltradosInterno.slice(indexOfFirstLead, indexOfLastLead);
  const totalPages = Math.ceil(fechadosFiltradosInterno.length / leadsPerPage);
  ...
  }, [fechadosFiltradosInterno, currentPage, totalPages]);
