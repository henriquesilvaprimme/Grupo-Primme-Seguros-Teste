...
                {/* NOVO CONTAINER PARA DATA E OBSERVAÇÃO */}
                {(lead.status === 'Em Contato' || lead.status === 'Sem Contato' || lead.status.startsWith('Agendado')) && (
                  <div style={{ flex: '1 1 45%', minWidth: '280px', borderLeft: '1px dashed #eee', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '15px' }}>
                    {/* NOVO: INPUT DE DATA - POSICIONADO ACIMA DA OBSERVAÇÃO */}
                    {lead.status.startsWith('Agendado') && (
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        <label htmlFor={`data-agendamento-${lead.id}`} style={{ marginBottom: '5px', fontWeight: 'bold', color: '#555' }}>
                          Data do Agendamento:
                        </label>
                        <input
                          id={`data-agendamento-${lead.id}`}
                          type="date"
                          // Aqui você precisaria gerenciar o estado para a data, similar à observação
                          // e o valor inicial viria do lead.status.
                          // Exemplo: value={lead.status.split(' - ')[1]}
                          style={{
                            padding: '8px',
                            borderRadius: '4px',
                            border: '1px solid #ccc',
