...
  const [paginaAtual, setPaginaAtual] = useState(1); // Estado para a paginação
  const leadsPorPagina = 10; // Quantidade de leads por página
...
    setPaginaAtual(1); // Reseta para a primeira página ao aplicar o filtro
...
    setPaginaAtual(1); // Reseta a paginação ao atualizar os leads
