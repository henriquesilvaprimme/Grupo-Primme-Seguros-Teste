...
    // Apenas chame o onUpdateStatus para salvar o status na planilha
    // O `onUpdateStatus` já contém a lógica de fetch
    await onUpdateStatus(leadId, novoStatus, phone, observacaoAgendamento);
...
      // Se for um agendamento, marque a observação como não editável após o salvamento
      setIsEditingObservacao(prev => ({ ...prev, [leadId]: false }));
    } else {
      setIsEditingObservacao(prev => ({ ...prev, [leadId]: false }));
    }
