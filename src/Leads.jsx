...
// ASSUMIMOS A MESMA URL BASE, se for diferente, ajuste aqui!
...
// ===============================================
// 2. COMPONENTE RENOMEADO PARA 'LeadsComponent'
// ===============================================
// Nomeado para 'LeadsComponent' para evitar conflito com o nome do arquivo 'Leads.jsx'
const LeadsComponent = ({ leads, usuarios, onUpdateStatus, transferirLead, usuarioLogado, fetchLeadsFromSheet, scrollContainerRef }) => {
